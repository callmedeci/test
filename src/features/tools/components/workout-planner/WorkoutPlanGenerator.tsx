...
import { Dumbbell, Clock, Target, TrendingUp, Activity, ChevronDown, ExternalLink, Play, Users, Calendar, Heart, Award, Zap } from 'lucide-react';
...
export default function WorkoutPlanGenerator({ profile }: WorkoutPlanGeneratorProps) {
  ...
  const generateWorkoutPlan = async () => {
    if (!profile) {
      alert('Please complete your profile first to generate a personalized workout plan.');
      return;
    }
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-blue-50 to-purple-50">
      <div className="max-w-7xl mx-auto p-6 space-y-8">
        ...
        <div className="text-center">
          ...
          {!profile && (
            <p className="text-sm text-red-600 mt-2">Please complete your profile first</p>
          )}
        </div>
